...
export const PORTALS: (PortalInfo & { icon: LucideIcon; color: string })[] = [
  ...
  },
  {
    ...
    label: "PORTAL SECRÉTARIAT FACULTÉ",
  ...
  },
  {
    ...
    label: "PORTAL SECRÉTARIAT GÉNÉRAL",
